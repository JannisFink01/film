{
  ...
  "author": "An Hoang, Valentin Moritz, Jannis Fink",
  "private": true,
  "license": "GPL-3.0",
  ...
  "scripts": {
    ...
    "pack": "pack build juergenzimmermann/film:1.0.0 --builder paketobuildpacks/builder:full",
    "postpack": "docker tag juergenzimmermann/film:1.0.0 juergenzimmermann/film:latest",
    "pack:clear-cache": "pack build juergenzimmermann/film:1.0.0 --builder paketobuildpacks/builder:base --clear-cache",
    "pack:inspect": "pack inspect juergenzimmermann/film:1.0.0",
    ...
    "rmi": "docker rmi juergenzimmermann/film:1.0.0",

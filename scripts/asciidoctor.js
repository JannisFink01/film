...
const options = {
    ...
    base_dir: '.extras/doc/entwicklerhandfilm',
    to_dir: 'html',
    mkdirs: true,
};
adoc.convertFile(
    join('.extras', 'doc', 'entwicklerhandfilm', 'entwicklerhandfilm.adoc'),
    options,
);
